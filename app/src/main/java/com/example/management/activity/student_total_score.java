...
import com.example.management.tools.Student;
import com.example.management.tools.StudentScoreAdapter;
import com.example.management.tools.myDatabaseHelper;
...
public class student_total_score extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initInfo();//初始化数据
        StudentScoreAdapter adapter = new StudentScoreAdapter(student_total_score.this, R.layout.student_sorce_item, list);
